...
template <typename T> Node<T>* BinarySearchTree<T>::RemoveSeqence(Node<T>* node, T _vaule) 
{
	if (node == nullptr)
		return node;
...
template <typename T> void BinarySearchTree<T>::RemoveNode(T _value)
{
	Node<T>* ptr = root;
	RemoveSeqence(ptr, _value);
}

template<typename T> void BinarySearchTree<T>::Display()
{
	Inorder(root);
}

template <typename T> bool BinarySearchTree<T>::SearchValue(T _value)
{
	Node<T>* ptr = root;
...
template <typename T> void BinarySearchTree<T>::AddNode(T _value)
{
